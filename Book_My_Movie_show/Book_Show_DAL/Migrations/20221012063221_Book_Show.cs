        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MovieId = table.Column<int>(type: "int", nullable: false),
                    TheatreId = table.Column<int>(type: "int", nullable: false),
                    TheaterTheatreId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_showTiming_theater_TheaterTheatreId",
                        column: x => x.TheaterTheatreId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_showTiming_TheaterTheatreId",
                table: "showTiming",
                column: "TheaterTheatreId");
